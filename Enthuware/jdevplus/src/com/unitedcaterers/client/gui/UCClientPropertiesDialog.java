...
/**
 * The purpose of this class is to capture initialization parameters such a server hostname, port, from the user.
 * @author Enthuware
 */
public class UCClientPropertiesDialog extends PropertiesDialog implements ActionListener {
    ...
    /**
     * We are using GridBagLayout as it is the most flexible and powerful standard layout manager.
     * This is specially suitable when you design the GUI without using and IDE.
     * IDEs typically use hardcoded size and location values which make the GUI screen very brittle.
     * However, you can use simpler layout managers as well.
     */
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (src == okBt) {
            ...
            File f = new File("."); //go to current directory - i.e. the directory from where the application has been run
