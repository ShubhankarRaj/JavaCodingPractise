...
/**
 * This is the database interface given in the requirements of the assignment. <br><br>
 ...
 * where you need to make a change to select the appropriate package.
 *
 * @author Enthuware
 * @version 1.0
 */
public interface DataBase {
     ...
     *is locked with a key other than lockkey.
     *@param recNo The record to be updated.
     *@param data The values that need to be stored.
     *@param lockkey The key using which the record was locked.
     */
     ...
     *data slot (row) available for reuse.
     *@param recNo The record that needs to be deleted.
     *@param lockkey The key using which the record was locked.
     *@throws SecurityException If the record is locked with a key other than lockkey.
     */
     ...
     *matches "Queen" or "Queens".)
     *@param criteria The values that need to be searched.
     ...
     *@return A Lock Key that should be used in subsequent calls to update, unlock, or delete.
     */
    public String lock(int recNo) throws RecordNotFoundException;

    /**
     *Releases the lock on a record. lockkey must be the key
     *that was returned when the record was locked; otherwise it throws SecurityException.
     *@param recNo The record to be unlocked.
     *@param lockkey The key that was used to lock the record.
     */
    public void unlock(int recNo, String lockkey) throws RecordNotFoundException, SecurityException;

    //The following four methods are there to illustrate the requirement where
    //lock and unlock methods do not use lock cookie.
    ...
    public void updateWithoutCookie(int recNo, String[] data)
            throws RecordNotFoundException, SecurityException;
    
    public void deleteWithoutCookie(int recNo)
            throws RecordNotFoundException, SecurityException;
}
