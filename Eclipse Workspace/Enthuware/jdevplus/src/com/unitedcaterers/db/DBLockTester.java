...
public class DBLockTester extends Thread {
    ...
    //Making it non-static so actual Thread classes will have their name in the log msg
    ...
    private class UpdateRecordThread extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                try {
                    /*
                     * If you comment out this line, all other threads
                     * that are trying to lock the same record should keep waiting.
                     * However, UpdateRandomThread, which may try other record should keep working.
                     */
